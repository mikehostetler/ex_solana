defmodule JidoHubWeb.RegisterLive do
    ...
    <div class="min-h-screen flex items-center justify-center bg-base-200 p-4">
      <div class="card w-full max-w-md bg-base-100 shadow-xl">
        <div class="card-body">
          ...
          <h2 class="card-title text-2xl font-bold justify-center mb-4">Create Account</h2>

          <%= if @magic_link_sent do %>
            <div class="alert alert-success">
              <.icon name="hero-check-circle" class="w-5 h-5" />
              <span>Magic link sent! Check your email to complete registration.</span>
            </div>
          <% else %>
            <%= if @show_magic_link do %>
              <form phx-submit="send_magic_link" class="space-y-4" id="magic-link-register-form">
            ...
            <% else %>
              ...
              >
                ...
                <div class="form-control">
                  <label for="user_username" class="label">
                ...
                <div class="form-control">
                  ...
                  <div class="relative">
                    ...
                    <button
                      ...
                      class="absolute inset-y-0 right-0 flex items-center pr-3 text-base-content/60 hover:text-base-content"
                      aria-label="Show password"
                      id="password-confirmation-toggle-button"
                    >
                      <.icon name="hero-eye" class="w-5 h-5" />
                      <.icon name="hero-eye-slash" class="w-5 h-5 hidden" />
                    </button>
              ...
              >
                <.icon name="hero-envelope" class="w-5 h-5 mr-2" /> Register with Magic Link
              </button>

              <%!-- OAuth providers (disabled until configured) --%>
              <div class="divider text-xs opacity-50">Social Sign Up (Coming Soon)</div>
