defmodule Hako do
  ...
  def write({adapter, config}, path, contents, opts \\ []) do
    with {:ok, normalized_path} <- Hako.RelativePath.normalize(path) do
  ...
  > following examples the [`Local`](`Hako.Adapter.Local`)
  > adapter is invoked, which returns a `File.Stream`.

  ### Direct filesystem

      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      {:ok, %File.Stream{}} = Hako.write_stream(filesystem, "test.txt")
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      {:ok, %File.Stream{}} = Hako.read_stream(filesystem, "test.txt")
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.move(filesystem, "test.txt", "other-test.txt")
  ...
  def move({adapter, config}, source, destination, opts \\ []) do
    with {:ok, normalized_source} <- Hako.RelativePath.normalize(source),
         {:ok, normalized_destination} <- Hako.RelativePath.normalize(destination) do
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.copy(filesystem, "test.txt", "other-test.txt")
  ...
  def create_directory({adapter, config}, path, opts \\ []) do
    with {:ok, normalized_path} <- Hako.RelativePath.normalize(path),
         {:ok, normalized_path} <- Hako.RelativePath.assert_directory(normalized_path) do
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.delete_directory(filesystem, "test/")
  ...
  @spec set_visibility(filesystem, Path.t(), Hako.Visibility.t()) :: :ok | {:error, term}
  ...
  @spec visibility(filesystem, Path.t()) :: {:ok, Hako.Visibility.t()} | {:error, term}
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      {:ok, %Hako.Stat.File{}} = Hako.stat(filesystem, "test.txt")
  ...
  ### Module-based filesystem
      ...
      {:ok, %Hako.Stat.File{}} = LocalFileSystem.stat("test.txt")

  """
  @spec stat(filesystem, Path.t()) ::
          {:ok, %Hako.Stat.File{} | %Hako.Stat.Dir{}} | {:error, term}
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.access(filesystem, "test.txt", [:read, :write])
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.append(filesystem, "test.txt", "Additional content")
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.truncate(filesystem, "test.txt", 100)
  ...
  ### Direct filesystem
      ...
      filesystem = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      :ok = Hako.utime(filesystem, "test.txt", DateTime.utc_now())
  ...
  ### Direct filesystem
      ...
      filesystem_source = Hako.Adapter.Local.configure(prefix: "/home/user/storage")
      filesystem_destination = Hako.Adapter.Local.configure(prefix: "/home/user/storage2")
      :ok = Hako.copy_between_filesystem({filesystem_source, "test.txt"}, {filesystem_destination, "copy.txt"})
  ...
  defp copy_via_local_memory(
    ...
    case {Hako.read_stream(source_filesystem, source_path, opts),
          Hako.write_stream(destination_filesystem, destination_path, opts)} do
      ...
      {{:ok, read_stream}, {:error, ^destination_adapter}} ->
        Hako.write(destination_filesystem, destination_path, Enum.into(read_stream, []))

      # Only B support streaming -> Load into memory and stream to B
      {{:error, ^source_adapter}, {:ok, write_stream}} ->
        with {:ok, contents} <- Hako.read(source_filesystem, source_path) do
          contents
      ...
      {{:error, ^source_adapter}, {:error, ^destination_adapter}} ->
        with {:ok, contents} <- Hako.read(source_filesystem, source_path) do
          Hako.write(destination_filesystem, destination_path, contents)
        end
    end
  rescue
  ...
  defp get_versioning_module(Hako.Adapter.Git), do: Hako.Adapter.Git
  defp get_versioning_module(Hako.Adapter.ETS), do: Hako.Adapter.ETS.Versioning
  defp get_versioning_module(Hako.Adapter.InMemory), do: Hako.Adapter.InMemory.Versioning
  ...
  ## Examples
      ...
      # Git adapter
      filesystem = Hako.Adapter.Git.configure(path: "/repo", mode: :manual)
      Hako.write(filesystem, "file.txt", "content")
      :ok = Hako.commit(filesystem, "Add new file")

      # ETS adapter (uses versioning wrapper)
      filesystem = Hako.Adapter.ETS.configure(name: :test_ets)
      :ok = Hako.commit(filesystem, "Snapshot")
  ...
  ## Examples
      ...
      # Git adapter
      filesystem = Hako.Adapter.Git.configure(path: "/repo")
      {:ok, revisions} = Hako.revisions(filesystem, "file.txt", limit: 10)
  ...
  ## Examples
      ...
      # Git adapter
      filesystem = Hako.Adapter.Git.configure(path: "/repo")
      {:ok, content} = Hako.read_revision(filesystem, "file.txt", "abc123")

      # ETS adapter
      filesystem = Hako.Adapter.ETS.configure(name: :test_ets)
      {:ok, content} = Hako.read_revision(filesystem, "file.txt", "version_id")
  ...
  ## Examples
      ...
      filesystem = Hako.Adapter.Git.configure(path: "/repo")
      :ok = Hako.rollback(filesystem, "abc123")

      # ETS adapter - single file rollback
      filesystem = Hako.Adapter.ETS.configure(name: :test_ets)
      :ok = Hako.rollback(filesystem, "version_id", path: "file.txt")
