defmodule ExSolana.SPL.TokenSwap do
  @moduledoc """
  Functions for interacting with ExSolana's [Token Swap
  ...
  """
  @spec id() :: binary
  def id, do: ExSolana.pubkey!("SwaPpA9LAaLfeLi3a68M4DjnLqgtticKg6CnyNwgAC8")
  ...
  @doc """
  Translates the result of a `ExSolana.RPC.Request.get_account_info/2` into
  ...
  def analyze_invocation(invocation, _decoded_txn) do
    invocation
  end

  def decode_events(list) do
    list
  end
