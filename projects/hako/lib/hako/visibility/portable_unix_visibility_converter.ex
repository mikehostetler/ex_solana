defmodule Hako.Visibility.PortableUnixVisibilityConverter do
  @moduledoc """
  `Hako.Visibility.UnixVisibilityConverter` supporting `Hako.Visibility.portable()`.
  ...
  def for_file(%Config{} = config, visibility) do
    with {:ok, visibility} <- Hako.Visibility.guard_portable(visibility) do
      case visibility do
