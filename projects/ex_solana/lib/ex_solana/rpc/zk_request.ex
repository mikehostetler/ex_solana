defmodule ExSolana.RPC.ZKRequest do
  ...
  def get_compressed_token_accounts_by_delegate(_delegate, _opts \\ []),
    do: {:error, :not_implemented}

  def get_transaction_with_compression_info(_signature, _opts \\ []),
    do: {:error, :not_implemented}

  def get_compressed_account_proof(_account, _opts \\ []), do: {:error, :not_implemented}

  def get_multiple_compressed_account_proofs(_accounts, _opts \\ []),
    do: {:error, :not_implemented}
  ...
  def get_compression_signatures_for_account(_account, _opts \\ []),
    do: {:error, :not_implemented}

  def get_compression_signatures_for_address(_address, _opts \\ []),
    do: {:error, :not_implemented}

  def get_compression_signatures_for_owner(_owner, _opts \\ []), do: {:error, :not_implemented}

  def get_compression_signatures_for_token_owner(_token_owner, _opts \\ []),
    do: {:error, :not_implemented}
