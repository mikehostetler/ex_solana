defmodule Kaizen.MixProject do
  ...
  @version "0.1.0"
  @source_url "https://github.com/agentjido/kaizen"
  @description "[EXPERIMENTAL] Evolutionary optimization and search utilities for Elixir. APIs may change without notice."
