# defmodule ExSolana.SPL.GovernanceTest do
#   use ExUnit.Case, async: true
#   @moduletag :solana
#   import ExSolana.TestHelpers, only: [create_payer: 3, keypairs: 1]
#   import ExSolana, only: [pubkey!: 1]

#   alias ExSolana.{Key, RPC, Transaction, SPL.Governance, SPL.Token, SPL.AssociatedToken}
...
#     {:ok, _signature} =
#       RPC.send_and_confirm(client, tracker, token_tx, commitment: "confirmed", timeout: 5_000)
