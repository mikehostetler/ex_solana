defmodule ExSolana.Jup do
  ...
  This module provides functions to interact with Jupiter's API for:
  ...
  @doc """
  Creates a Tesla client for Jupiter API requests.

  ## Options

  Currently, no options are supported. The client uses the base URL
  from configuration or defaults to the official Jupiter API.
  ...
  ## Examples
      ...
      iex> ExSolana.Jup.quote(client, "So11111111111111111111111111111111111111112", "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", 1_000_000_000, 50)
      {:ok, %{...}}
  ...
  ## Examples
      ...
      iex> ExSolana.Jup.swap_instructions(client, %{...}, "user_public_key")
      {:ok, %{...}}
  ...
  ## Examples
      ...
      iex> ExSolana.Jup.swap(client, %{...}, "user_public_key")
      {:ok, %{...}}
  ...
  - `options`: Additional options (optional map)
    - `:show_extra_info` - Boolean to include additional information (default: false)
  ...
  ## Examples
      ...
      iex> ExSolana.Jup.set_base_url("https://new-api-url.com")
      :ok
