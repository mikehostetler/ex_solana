defmodule Hako.Adapter do
  @moduledoc """
  Behaviour for how `Hako` adapters work.
  """
  @type path :: Path.t()
  ...
  @callback set_visibility(config, path, Hako.Visibility.t()) :: :ok | {:error, term}
  @callback visibility(config, path) :: {:ok, Hako.Visibility.t()} | {:error, term}
