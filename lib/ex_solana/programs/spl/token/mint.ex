defmodule ExSolana.SPL.Token.Mint do
  @moduledoc """
  Functions for interacting with the mint accounts of ExSolana's [Token
  ...
  @type t :: %__MODULE__{
          authority: ExSolana.key() | nil,
          supply: non_neg_integer,
          decimals: byte,
          initialized?: boolean,
          freeze_authority: ExSolana.key() | nil
        }
