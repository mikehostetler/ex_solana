defmodule Hako.Adapter.InMemory.VersioningTest do
  use ExUnit.Case, async: true

  alias Hako.Adapter.InMemory
  alias Hako.Adapter.InMemory.Versioning
  ...
  describe "revisions/3" do
    ...
    test "lists versions with standardized format", %{config: config} do
      ...
      assert revision.author_email == "inmemory@hako.local"
