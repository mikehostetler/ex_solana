defmodule Hako.Adapter.GitHub do
  @moduledoc """
  ...
  ## Configuration
      ...
      config = Hako.Adapter.GitHub.configure(
        owner: "username",
  ...
  ## Examples
      ...
      # Read a file
      {:ok, content} = Hako.read(config, "README.md")

      # Write a file (creates a commit)
      :ok = Hako.write(config, "new_file.txt", "content", 
                        message: "Add new file", 
                        committer: %{name: "Your Name", email: "your@email.com"})

      # List directory contents
      {:ok, files} = Hako.list_contents(config, "src/")

  """

  @behaviour Hako.Adapter

  alias Hako.Stat.File
  alias Hako.Stat.Dir
  ...
  # Convert GitHub API content response to Hako.Stat
